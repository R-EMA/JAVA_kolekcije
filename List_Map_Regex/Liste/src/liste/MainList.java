...
public class MainList {
	...
	public static void main(String[] args) {
		...
		System.out.println(stk);
		// stek metod .peek() samo čita vrednost poslednjeg elementa
		System.out.println("Pročitano: " + stk.peek());
		System.out.println(stk);
		// i ovde mogu da se koriste standardni List metodi
		// .remove(i) za brisanje elementa sa određene pozicije
		// ...  .remove(stk.size()-1) = .pop()
		// .clear() za pražnjenje steka
		// .get(i) za čitanje vrednosti sa određene pozicije
		// ... .get(stk.size()-1) = .peek()
		// može se izvršiti iteracija petljama for, ali i iteratorima
		itr = stk.iterator(); // reinicijalizacija postojećeg iteratora na stek
		while(itr.hasNext())
			System.out.print(itr.next() + " ");
		System.out.println("");
 ...
 * 
 * Interfejs List implementiraju klase ArrayList, LinkedList, Vector i Stack.
 * 
 * P.S. Većina metoda za rad sa ArrayList i LinkedList je obrađena na 
 * predavanjima i vežbama, a ti isti metodi su primenljivi i na Vektor i na Stack
 * 
 */
